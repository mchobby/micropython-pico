""" ws2812.py - WS2812 / NeoPixel easy to use library for RP2040.

	Note: Later revision of MicroPython 1.21 does have a Machine.Neopixel class.
		  Use NeoPixel class when available in your firmware.
